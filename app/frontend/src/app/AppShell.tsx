...
function App({ logout, sessionUserId }: { logout: () => void; sessionUserId: string }) {
  ...
  const {
    ...
    editScheduleRunOnStatuses,
    editScheduledInstruction,
    editRecurringEvery,
    editRecurringUnit,
    editStatusTriggerSelfEnabled,
    editStatusTriggerSelfFromStatusesText,
    editStatusTriggerSelfToStatusesText,
    editStatusTriggerExternalEnabled,
    editStatusTriggerExternalMatchMode,
  ...
  useTaskNoteEditorEffects({
    ...
    setEditScheduleRunOnStatuses,
    setEditScheduledInstruction,
    setEditRecurringEvery,
    setEditRecurringUnit,
    setEditStatusTriggerSelfEnabled,
    setEditStatusTriggerSelfFromStatusesText,
    setEditStatusTriggerSelfToStatusesText,
    setEditStatusTriggerExternalEnabled,
    setEditStatusTriggerExternalMatchMode,
    setEditStatusTriggerExternalTaskIdsText,
  ...
  return (
    <AppContent
      ...
      contextLimitTokensDefault: Number(bootstrap.data.agent_chat_context_limit_tokens_default || 0),
      editProjectMemberIds,
      toggleEditProjectMember,
      selectedProjectCreator,
      selectedProjectTimeMeta,
