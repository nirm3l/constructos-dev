...
AGENT_RUNNER_MAX_CONCURRENCY = max(1, _env_int("AGENT_RUNNER_MAX_CONCURRENCY", 4))
...
EVENT_STORMING_ENABLED = _env_bool("EVENT_STORMING_ENABLED", False)
...
EVENT_STORMING_AI_MODEL = os.getenv("EVENT_STORMING_AI_MODEL", "").strip()
EVENT_STORMING_AI_PROVIDER = os.getenv("EVENT_STORMING_AI_PROVIDER", "").strip()
EVENT_STORMING_AI_LOCAL_PROVIDER = os.getenv("EVENT_STORMING_AI_LOCAL_PROVIDER", "").strip()
