...
AGENT_OPENCODE_DEFAULT_MODEL = _env_first(("AGENT_OPENCODE_DEFAULT_MODEL", "AGENT_OPENCODE_MODEL"), "opencode/minimax-m2.5-free")
...
AUTH_SESSION_COOKIE_NAME = os.getenv("AUTH_SESSION_COOKIE_NAME", "constructos_session").strip() or "constructos_session"
...
DOCTOR_RUNTIME_CONTRACT_AUDIT_AUTO_ENABLED = _env_bool("DOCTOR_RUNTIME_CONTRACT_AUDIT_AUTO_ENABLED", False)
DOCTOR_RUNTIME_CONTRACT_AUDIT_AUTO_INTERVAL_SECONDS = max(
    60.0, _env_float("DOCTOR_RUNTIME_CONTRACT_AUDIT_AUTO_INTERVAL_SECONDS", 3600.0)
)
...
SEED_CONSTRUCTOS_INTERNAL_ENABLED = _env_bool("SEED_CONSTRUCTOS_INTERNAL_ENABLED", False)
